...
namespace customMD{
    public class Converter{
        public MDDOM Mddom;
        public HTML html;
        public static bool saveStaticFiles = false;
        ...
        public static Mark MultiConvert(MDC_MultiComponentDiv multiComponentDiv){
            if (multiComponentDiv is MDC_Block block){
                ...
                return blockMark;
            }else if (multiComponentDiv is MDC_OrderedList ol){
                ...
                return OLMark;
            }else if (multiComponentDiv is MDC_UnorderedList ul){
